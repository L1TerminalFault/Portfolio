              ...
              <div className="flex /relative gap-2 flex-wrap /z-20">
                {preferredTechStack.map((each) => (
                  ...
                  >
                    ...
                    <div className="absolute translate-y-20 z-30 backdrop-blur-3xl group-hover:max-w-120 max-h-0 group-hover:max-h-40 max-w-0 rounded-2xl flex overflow-hidden group-hover:gap-4 group-hover:p-6 opacity-0 group-hover:opacity-100 bg-gray-900/90 transition-all duration-500 shadow-lg shadow-black/50">
